...
Este projeto tem como objetivo analisar o perfil e a evolução dos imigrantes brasileiros para o Canadá.
...
A base de dados utilizada, [`imigrantes_canada.csv`](imigrantes_canada.csv), contém informações sobre o número de imigrantes de diversos países para o Canadá, segmentadas por ano. Os principais campos incluem país de origem, ano e quantidade de imigrantes.
